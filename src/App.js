...
function ChicagoLiveComponent({ onBack }) {
  const cameras = [
    ...
    { id: "lakefront", label: "CAM-C / LAKE SHORE DRIVE — LAKEFRONT", coords: "41.8663°N 87.6170°W — LAKE MICHIGAN", desc: "4K Lake Shore Drive surveillance.", embed: "https://www.youtube-nocookie.com/embed/LTxb6XBJwq4?autoplay=1&mute=1&controls=0&modestbranding=1&rel=0" },
  ]
  return (
    <div style={{ maxWidth: 760, margin: "0 auto", padding: "20px" }}>
